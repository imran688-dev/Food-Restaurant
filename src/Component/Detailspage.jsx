        ...
        (!item) ? "" : (
          ...
          <>
            <div className="content">
              ...
              <div className="inner-content max-w-[500px]">
                <h1>{item.strMeal}</h1>
                <h2>{item.strAreal} Food</h2>
                <h3>Category {item.strCategory}</h3>
              </div>
            </div>
            <div className='food-details'>
              <div className='ingredients underline'>
              ...
              <div className='instruction'>
                <h2 className='underline'>Instructions</h2> <br />
                <h4>{item.strInstructions.slice(0, 500)}...</h4>
              </div>
              <div>
                <iframe className='video' src={`https://www.youtube.com/embed/${vId}`}>
